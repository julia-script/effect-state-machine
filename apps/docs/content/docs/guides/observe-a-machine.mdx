...
The embedded counter exposes its current snapshot, accepted quick events, committed-state history,
and inspection-derived transition activity together. Select **Start counting** and
**Increment by 3** to create records, then move the History cursor between them.
