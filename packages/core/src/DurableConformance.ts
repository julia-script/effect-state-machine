...
const expectFailureTag = <A, E extends { readonly _tag: string }>(
  ...
  Effect.matchEffect(effect, {
    ...
    onSuccess: () => Effect.die(new Error(`Durable.Store conformance: expected ${tag}`)),
  })
    ...
    },
    {
      ...
      run: Effect.gen(function* () {
        ...
        yield* store.commitMachine({
          ...
          cancelExecutionKeys: [oldActivity.executionKey as ExecutionKey],
          dispatch: undefined,
        })
    ...
    },
    {
      ...
      run: Effect.gen(function* () {
        ...
        yield* store.commitMachine({
          ...
          publishActivities: [],
          cancelMessageIds: [],
          cancelExecutionKeys: [running.executionKey as ExecutionKey],
          dispatch: undefined,
        })
        yield* expectFailureTag(
          store.completeActivity(
